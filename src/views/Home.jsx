  ...
  return (
    <div>
      <div className="Banner">
        ...
        <p>------------------------------------------------------------</p>
        <button className="btnNF" onClick={() => navigate(`/NotFound404`)}> Para probar Not Found </button>
      </div>
          ...
          <div className="card" key={e.id}>
            ...
            <div className="text-card">
              ...
              <div className="box-button">
                <button className="btninfo" onClick={() => navigate(`/pizza/${e.id}`)}> Más Info 👀 </button>
                <button className="btnadd" onClick={() => addCart(e)}> Agregar 🛒 </button>
              </div>
            </div>
          </div>
        ))}
